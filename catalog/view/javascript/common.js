		...
		$.ajax({
			...
			success: function(json) {
                ...
                if (json.success) {
					...
					setTimeout(function () {
						$('#cart > button').html('<div class="cimg"><svg width="35px" height="35px"><use xlink:href="#hcart"></use></svg></div> <div class="discri text-left"><div id="cart-text" class="text-capitalize mcart hidden-sm-down">my cart - </div> ' + json['total'] + '</div>');
					 }, 100);
